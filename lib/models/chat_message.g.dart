...
void _chatMessageSerialize(
  ...
  writer.writeBool(offsets[1], object.isFromUser);
...
ChatMessage _chatMessageDeserialize(
  ...
  final object = ChatMessage(
    ...
    isFromUser: reader.readBool(offsets[1]),
...
extension ChatMessageQuerySortBy
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> sortByIsFromUser() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isFromUser', Sort.asc);
    });
  }

  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> sortByIsFromUserDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ChatMessageQuerySortThenBy
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> thenByIsFromUser() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isFromUser', Sort.asc);
    });
  }

  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> thenByIsFromUserDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isFromUser', Sort.desc);
    });
  }
...
extension ChatMessageQueryWhereDistinct
  ...
  QueryBuilder<ChatMessage, ChatMessage, QDistinct> distinctByImageBytes() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'imageBytes');
    });
  }

  QueryBuilder<ChatMessage, ChatMessage, QDistinct> distinctByIsFromUser() {
    return QueryBuilder.apply(this, (query) {
...
extension ChatMessageQueryProperty
  ...
  QueryBuilder<ChatMessage, List<int>?, QQueryOperations> imageBytesProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'imageBytes');
    });
  }

  QueryBuilder<ChatMessage, bool, QQueryOperations> isFromUserProperty() {
    return QueryBuilder.apply(this, (query) {
